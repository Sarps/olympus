...
export class TransactionPartyDto {
  constructor(public narration: string, public userId: string, public name: string) {
  }
}
...
export class TransactionResponseDto {
  ...
  static fromEntity(entity: TransactionEntity): TransactionResponseDto {
    ...
    return new TransactionResponseDto(
      ...
      type === TransactionType.CREDIT ? new TransactionPartyDto(sender.narration, sender.userId, sender.name) : undefined,
      type === TransactionType.DEBIT ? new TransactionPartyDto(recipient.narration, recipient.userId, recipient.name) : undefined
    );
  }
}
