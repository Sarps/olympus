...
import { IsAlphanumeric, IsDefined, IsEmail, IsEmpty, IsNotEmpty, IsStrongPassword, ValidateIf } from "class-validator";
...
export class AuthRegisterDto {
  ...
  email: string;
  @ApiProperty({
    description: "Password length must minimum of 10. At least a lowercase, uppercase, number and symbol ",
  ...
  password: string;
  @ApiProperty({ description: "Password confirmation", example: "ZL4IW90N7Wsn3IC!" })
  @IsDefined()
